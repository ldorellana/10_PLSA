...
pipeline_folder = f'/FileStore/files/LDA_MODELS/NEW_CATS/11_25/'
...
mkdir ../../dbfs/FileStore/files/LDA_MODELS/reports/cluster12_16/
...
for pipeline_no, (pipeline_name, results)  in enumerate(pipeline_results.items()):
  ...
  loc = '../../dbfs/FileStore/files/LDA_MODELS/reports/categories_v2/'
  title = 'フレスコークラスタリング'
...
df_excel.coalesce(1).write.csv('/FileStore/files/LDA_MODELS/11_25/v2_clust_8_12_16.csv', header=True)
